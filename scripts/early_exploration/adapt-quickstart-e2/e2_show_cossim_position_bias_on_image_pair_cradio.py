...
output_dir = "data/intermediates/patch_matching/position_bias_pair_cradio"
...
def extract_features():
    ...
    # Get nearest supported resolution for image 1
    nearest_res1 = model.get_nearest_supported_resolution(image1_pil.size[1], image1_pil.size[0])
    image1_resized = image1_pil.resize((nearest_res1.width, nearest_res1.height), Image.Resampling.LANCZOS)

    # Process image 1
    inputs1 = processor(images=image1_resized, return_tensors="pt")
    with torch.no_grad():
        outputs1 = model(inputs1['pixel_values'])

    # C-RADIO returns features with shape [batch, num_patches, channels]
    features1 = outputs1.features.squeeze(0).cpu().numpy().astype(np.float32)
    print(f"    Features shape: {features1.shape}")

    print("  Encoding Image 2...")

    # Get nearest supported resolution for image 2
    nearest_res2 = model.get_nearest_supported_resolution(image2_pil.size[1], image2_pil.size[0])
    image2_resized = image2_pil.resize((nearest_res2.width, nearest_res2.height), Image.Resampling.LANCZOS)

    # Process image 2
    inputs2 = processor(images=image2_resized, return_tensors="pt")
    with torch.no_grad():
        outputs2 = model(inputs2['pixel_values'])

    features2 = outputs2.features.squeeze(0).cpu().numpy().astype(np.float32)
...
# ============================================================================
# STEP 4: Compute similarity matrix (without normalization, like original)
# ============================================================================
...
# ============================================================================
# We need the resized images for proper coordinate mapping
nearest_res1 = model.get_nearest_supported_resolution(image1_pil.size[1], image1_pil.size[0])
...
# ============================================================================
# STEP 5: Create patch coordinate system
# ============================================================================
...
# ============================================================================
# STEP 9: Create histogram of cosine similarity by patch index
# ============================================================================
...
def create_similarity_histogram():
    ...
    ax.set_title('Distribution of Cosine Similarity Across All Patch Pairs (C-RADIOv4)', fontsize=14, fontweight='bold')
...
# ============================================================================
# STEP 10: Create scatter plot of patch index vs cosine similarity
# ============================================================================
...
def create_scatter_plot():
    ...
    ax.set_title('Cosine Similarity Distribution Across Flattened Patch Indices (C-RADIOv4)', fontsize=14, fontweight='bold')
    ax.grid(True, alpha=0.3, linestyle='--')
...
# ============================================================================
# STEP 11: Create merged scatter plot (top p, bottom p, random p)
# ============================================================================
...
def create_merged_scatter_plot():
    ...
    ax.set_xlabel('Flattened Patch Index', fontsize=12, fontweight='bold')
    ax.set_ylabel('Cosine Similarity', fontsize=12, fontweight='bold')
    ax.set_title('Cosine Similarity: Top vs Bottom vs Random Samples (C-RADIOv4)', fontsize=14, fontweight='bold')
    ax.grid(True, alpha=0.3, linestyle='--')
...
# ============================================================================
# STEP 12: Create merged plot showing cosine similarity vs y-axis patch position
# ============================================================================
...
def create_merged_plot_y_position():
    ...
    ax.set_ylabel('Cosine Similarity', fontsize=12, fontweight='bold')
    ax.set_title('Cosine Similarity vs Y-Axis Patch Position (Image 1) (C-RADIOv4)', fontsize=14, fontweight='bold')
    ax.grid(True, alpha=0.3, linestyle='--')
    ax.legend(loc='upper right', fontsize=10, framealpha=0.9)
...
# ============================================================================
# STEP 13: Create merged plot showing cosine similarity vs x-axis patch position
# ============================================================================
...
def create_merged_plot_x_position():
    ...
    ax.set_ylabel('Cosine Similarity', fontsize=12, fontweight='bold')
    ax.set_title('Cosine Similarity vs X-Axis Patch Position (Image 1) (C-RADIOv4)', fontsize=14, fontweight='bold')
    ax.grid(True, alpha=0.3, linestyle='--')
    ax.legend(loc='upper right', fontsize=10, framealpha=0.9)
