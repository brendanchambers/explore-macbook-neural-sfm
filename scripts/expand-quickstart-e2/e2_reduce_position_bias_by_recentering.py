...
image2_path = "data/incoming/images/frame_0100.jpg"

# Output directory for all generated files
output_dir = "data/intermediates/patch_matching/recentered"
...
def compute_mean_patch_features():
    ...
    store them in a 3D array (N_sampled_images x N_patches x D_patch),
    ...
    for img_file in tqdm(image_files, desc="  Encoding images"):
        ...
        try:
            ...
            features = encoder.encode(img_array).astype(np.float32)  # [N_patches, D_patch]
    ...
    # Stack all features into 3D array [N_sampled_images, N_patches, D_patch]
    # Note: We'll store them as a list since they might have different N_patches
    ...
    # We'll average across images (dim 0)
    # Note: If images have different numbers of patches, we need to be careful
    # For now, assume they all have the same number of patches or handle dynamically
...
# ============================================================================
@log_step("6. Compute outer product matrix")
